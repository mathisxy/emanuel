...
def get_minecraft_vanilla_server_status() -> str:
    """Online Status des *Minecraft Vanilla Servers*.
...
def get_minecraft_drehmal_server_status() -> str:
    """Online Status des *Minecraft Drehmal Adventure Servers*.
...
def start_minecraft_drehmal_server() -> str:
    """Startet Minecraft Drehmal Adventure Server"""
    result = subprocess.run(
...
def stop_minecraft_drehmal_server() -> str:
    """Stoppt Minecraft Drehmal Adventure Server"""
    result = subprocess.run(
...
def restart_minecraft_drehmal_server() -> str:
    """Startet Minecraft Drehmal Adventure Server neu"""
    result = subprocess.run(
...
def get_enshrouded_server_status() -> str:
    """Online Status des *Enshrouded Servers*.
...
def update_enshrouded_server() -> str:
    """Updated den Enshrouded Server. Wird gestoppt, geupdatet und wieder gestartet."""
