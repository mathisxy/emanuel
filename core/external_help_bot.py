...
def use_help_bot(message: discord.Message):
    ...
    if isinstance(message.channel, discord.TextChannel):
        ...
        is_member = Config.HELP_DISCORD_ID in [member.id for member in message.channel.members]

        logging.debug(f"DISCORD HELP BOT: Is {Config.HELP_DISCORD_ID} member: {is_member}")
